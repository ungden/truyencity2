  ...
  openrouter: {
    ...
    models: [
      ...
      },
      {
        ...
        description: 'Google Gemini with extended thinking via OpenRouter',
    ...
    models: [
      {
        ...
        description: 'Primary model — fast, 1M context, free tier available',
        contextWindow: 1000000,
        maxOutputTokens: 65536,
        costPer1kInput: 0.0,
        costPer1kOutput: 0.0,
      ...
      },
      {
        ...
        description: 'Next-gen Flash with thinking, 1M context',
        contextWindow: 1000000,
        maxOutputTokens: 65536,
        costPer1kInput: 0.0,
        costPer1kOutput: 0.0,
      },
      {
        ...
        description: 'Most capable Gemini — use for complex planning only',
        contextWindow: 1000000,
        maxOutputTokens: 65536,
