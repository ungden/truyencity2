...
export const STORY_FACTORY_SEQUENTIAL_PROTOCOL = 'story-factory-sequential-survival-v10-derived-capacity-minutes';
export const STORY_FACTORY_BENCHMARK_PROTOCOL = 'story-factory-validation-v16-derived-capacity-minutes';
