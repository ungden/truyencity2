...
export const STORY_FACTORY_SEQUENTIAL_PROTOCOL = 'story-factory-sequential-survival-v9-compact-window-wire';
export const STORY_FACTORY_BENCHMARK_PROTOCOL = 'story-factory-validation-v15-compact-window-wire';
