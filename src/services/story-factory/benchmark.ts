...
export const STORY_FACTORY_WRITER_BAKEOFF_PROTOCOL = 'story-factory-writer-bakeoff-v10-exact-resume-preserves-completed';
export const STORY_FACTORY_SEQUENTIAL_PROTOCOL = 'story-factory-sequential-survival-v4-next-opening-handoff';
export const STORY_FACTORY_BENCHMARK_PROTOCOL = 'story-factory-validation-v10-exact-resume-preserves-completed';
