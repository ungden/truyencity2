...
export const STORY_FACTORY_SEQUENTIAL_PROTOCOL = 'story-factory-sequential-survival-v8-explicit-time-budget';
export const STORY_FACTORY_BENCHMARK_PROTOCOL = 'story-factory-validation-v14-explicit-time-budget';
