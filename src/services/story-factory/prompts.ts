export const FACTORY_PROMPT_VERSION = 'story-factory-2026-07-29.11-immediate-intent-handoff';
...
nextOpening chỉ khóa điểm bàn giao cơ học cho chương kế tiếp. Nếu một nhân vật nằm trong mustRemainAvailableAt, không được cho họ rời địa điểm đó hoặc rơi vào tình trạng không thể tham gia điểm mở đầu kế tiếp. Nếu unwrittenGapMinutes=0, đoạn kết không được hứa chờ đợi, trì hoãn hoặc nuôi dưỡng trước khi thực hiện immediateObjective; ý định cuối chương phải cho phép objective đó bắt đầu ngay. Không được nhắc nextOpening trong prose.
...
Đối chiếu plannedEndState và nextOpening: đoạn kết không được đảo ngược required delta vừa hoàn tất hoặc cho nhân vật trong mustRemainAvailableAt rời địa điểm, mất khả năng hay mâu thuẫn với điểm mở đầu kế tiếp. Khi unwrittenGapMinutes=0, mọi lời hứa chờ đợi, để phát triển, để hồi phục hoặc trì hoãn trước immediateObjective là lỗi prose. Đây là lỗi prose và phải có evidence ngay tại câu gây mâu thuẫn.
