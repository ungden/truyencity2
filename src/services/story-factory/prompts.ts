export const FACTORY_PROMPT_VERSION = 'story-factory-2026-07-24.1';
...
Bạn được tự do cách kể nhưng không được tự tạo thay đổi trạng thái bền vững ngoài requiredDeltas: không tự phát sinh giao dịch, tiền, vật phẩm, tri thức, vị trí, promise hoặc quan hệ mới. State trong brief có quyền ưu tiên nếu đoạn cuối chương trước mâu thuẫn với nó.
