...
export const FACTORY_SETUP_VERSION = 'story-factory-setup-20-mechanic-aware-launch-pack';
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-18-owned-resource-mechanics';
