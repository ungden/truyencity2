...
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-50-exact-preconditions-and-mechanic-guide';
export const FACTORY_CONTEXT_VERSION = 'story-factory-context-12-next-opening-handoff';
