...
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-53-reported-future-transfers';
export const FACTORY_CONTEXT_VERSION = 'story-factory-context-13-active-mechanic-instructions';
