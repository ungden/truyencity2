...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-18-fail-closed-attempt-telemetry';
...
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-12-concise-mechanical-window';
