...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-26-input-output-conversions';
export const FACTORY_STATE_VERSION = 'story-factory-state-9-exact-id-continuity-packet';
export const FACTORY_SETUP_VERSION = 'story-factory-setup-24-lossless-conversion-contract';
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-24-input-output-atomic-batches';
