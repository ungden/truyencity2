...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-27-capability-effects';
export const FACTORY_STATE_VERSION = 'story-factory-state-9-exact-id-continuity-packet';
export const FACTORY_SETUP_VERSION = 'story-factory-setup-27-explicit-capability-effects';
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-25-capability-effect-ownership';
