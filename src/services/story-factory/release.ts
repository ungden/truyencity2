...
export const FACTORY_SETUP_VERSION = 'story-factory-setup-39-input-bound-checkpoints';
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-47-exact-capability-inference';
