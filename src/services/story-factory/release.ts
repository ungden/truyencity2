...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-28-provider-visible-positive-bounds';
export const FACTORY_STATE_VERSION = 'story-factory-state-9-exact-id-continuity-packet';
export const FACTORY_SETUP_VERSION = 'story-factory-setup-28-provider-visible-positive-bounds';
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-26-provider-visible-positive-bounds';
