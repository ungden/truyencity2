...
export const FACTORY_SETUP_VERSION = 'story-factory-setup-30-neutral-hyphenated-traits';
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-33-derived-nonnumeric-before-state';
