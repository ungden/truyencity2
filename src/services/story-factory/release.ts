...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-25-optional-chapter-rules';
...
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-23-relevant-rules-only';
