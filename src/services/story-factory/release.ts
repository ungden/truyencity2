...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-42-bounded-editor-provider-schema';
...
export const FACTORY_CONTEXT_VERSION = 'story-factory-context-21-grounded-comparative-rates';
