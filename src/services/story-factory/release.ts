...
export const FACTORY_CONTRACT_VERSION = 'story-factory-contracts-41-exact-first-encounter';
...
export const FACTORY_PLANNER_VERSION = 'story-factory-planner-61-exact-first-encounter';
export const FACTORY_CONTEXT_VERSION = 'story-factory-context-20-exact-first-encounter';
