...
const SOURCE_TOPIC_SEEDS: Record<string, string[]> = {
  ...
  'kiem-hiep': [
    'thiếu niên mồ côi lĩnh ngộ tuyệt thế kiếm pháp từ bia đá cổ',
    'bí kíp Cửu Âm Chân Kinh bị chia thành bảy mảnh, giang hồ tranh đoạt',
    'nữ hiệp cải trang thành nam, hành hiệp giang hồ phá vỡ âm mưu',
    'sát thủ thoát khỏi tổ chức, bị truy sát khắp giang hồ',
    'võ lâm minh chủ bị hàm oan, MC minh oan và trả thù',
    'đại hiệp trở về sau 20 năm ẩn cư, giang hồ đã đổi thay',
    'mở võ quán nhỏ từ tay trắng thành đệ nhất môn phái',
    'thám tử giang hồ phá án bằng võ công và suy luận',
  ],
  'mat-the': [
    'zombie tràn lan, MC xây dựng base sinh tồn từ siêu thị bỏ hoang',
    'dị năng giả thức tỉnh sau virus toàn cầu, tranh đoạt tinh thể',
    'trọng sinh về 3 ngày trước tận thế, tích trữ vật tư xây bunker',
    'băng hà đột ngột, di cư tìm vùng đất ấm cuối cùng',
    'côn trùng đột biến tấn công, chống lại trùng mẫu hoàng hậu',
    'hệ thống sinh tồn cho nhiệm vụ, hoàn thành hoặc bị trừng phạt',
    'mực nước biển dâng 100m, sinh tồn trên thuyền và đảo nổi',
    'phế thổ hậu hạt nhân, scavenger lặn phế tích tìm công nghệ cũ',
    'virus biến người thành quái vật ban đêm, MC bảo vệ khu dân cư',
  ],
  'linh-di': [
    'pháp sư kế thừa dòng tộc, mỗi vụ án tâm linh hé lộ bí mật lớn',
    'quy tắc quái đàm: tuân thủ đúng thì sống, sai thì chết',
    'phong thủy sư đổi vận mệnh, mỗi huyệt mộ một bí ẩn',
    'âm dương nhãn nhìn thấy ma, MC giải oan cho vong linh',
    'cổ mộ thám hiểm, cơ quan trận pháp và tà linh cổ đại',
    'bệnh viện bỏ hoang có tiếng khóc ban đêm, MC điều tra',
    'thầy trừ tà đối đầu giáo chủ tà phái trong đêm trăng máu',
    'ma quỷ dân gian Việt: ma da, cô hồn, thần tài, ông địa',
    'thám tử tâm linh phá án bằng phong thủy và bùa chú',
  ],
  'quan-truong': [
    'cán bộ xã thăng tiến nhờ tài mưu lược và nhân mạch',
    'trọng sinh về đầu sự nghiệp, tránh sai lầm kiếp trước',
    'chống tham nhũng trong hệ thống quan liêu phức tạp',
    'phát triển kinh tế huyện nghèo thành mô hình điểm quốc gia',
    'quan trường cổ đại: từ hàn môn sĩ tử leo lên tể tướng',
    'mưu kế chính trường đa tầng, đồng minh hôm nay kẻ thù ngày mai',
    'ngoại giao quốc tế, đàm phán thương mại giữa các cường quốc',
    'nữ chính thăng tiến trong quan trường nam quyền',
  ],
  'di-gioi': [
    'xuyên không sang dị giới làm lãnh chúa, xây thành từ hoang vu',
    'sinh tồn trong dị giới nguy hiểm với hệ thống golden finger',
    'buôn bán giữa hai thế giới, bật lửa đổi thần khí',
    'mở tiệm thuốc ở dị giới bằng y học hiện đại',
    'nông trại điền viên ở dị giới, trồng linh thảo nuôi ma thú',
    'đem quân sự hiện đại chinh phạt dị giới trung cổ',
    'xuyên không thành thú nhỏ yếu ớt, tiến hóa thành cường giả',
    'mở nhà hàng ở dị giới, nấu ăn hiện đại chinh phục vương tộc',
    'kỹ sư xuyên không cải cách công nghiệp dị giới từ thời đồ đá',
  ],
  'ngon-tinh': [
    'tổng tài lạnh lùng yêu cô gái bình thường, sủng chiều vô điều kiện',
    'xuyên không thành hoàng hậu bị ghẻ lạnh, lật kèo hậu cung',
    'trọng sinh nữ chính phục thù kẻ hại mình kiếp trước',
    'hợp đồng hôn nhân giả thành tình thật, ngọt ngào',
    'nữ bác sĩ gặp tổng tài bệnh nhân, tình yêu từ bệnh viện',
    'hai thanh mai trúc mã tái ngộ sau 10 năm xa cách',
    'nữ chính vào cửa hào môn, đối phó mẹ chồng và tiểu tam',
    'cổ đại: vương gia lạnh lùng sủng thê, ghen tuông bá đạo',
