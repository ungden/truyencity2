...
export const SUB_GENRE_RULES: Record<string, string[]> = {
  ...
  'xuyen-viet': [
    'XUYÊN VIỆT PATTERNS (穿越 — người hiện đại xuyên về cổ đại/dị giới, leverage = TRI THỨC HIỆN ĐẠI):',
    '  • Knowledge-gap = golden finger: MC dùng tri thức hiện đại (khoa học / thương mại / quân sự / nông nghiệp / y học / công thức) mà thế giới bản địa CHƯA CÓ → mỗi 1-2 chương 1 lần MC nhận ra "thứ này thời này chưa có, ta biết cách làm".',
    '  • Reminiscence = so sánh 2 thời đại: trigger (món ăn / dụng cụ thô sơ / tập tục lạc hậu) → 1-2 câu MC nhớ cách làm ở hiện đại → áp dụng. KHÔNG paragraph dump lịch sử.',
    '  • Leverage có COST: tri thức hiện đại không tự chạy — thiếu nguyên liệu / công cụ / nhân lực thời cổ → MC phải improvise, có thể fail lần đầu. CẤM "MC vẽ bản thiết kế → ngày mai có ngay".',
    '  • Bản địa hóa: MC phải GIẢI THÍCH được nguồn gốc tri thức (vỏ bọc: "gia truyền / kỳ thư / dị nhân chỉ dạy") để không lộ thân phận xuyên việt.',
    '  • Anti-overpowered: MC KHÔNG nhớ MỌI công thức hoàn chỉnh — nhớ nguyên lý, phải thử-sai để ra thành phẩm. Kiến thức lệch ngành (dân IT không biết luyện thép) là điểm yếu hợp lý.',
    '  • Cultural friction: tri thức/giá trị hiện đại (nam nữ bình quyền, vệ sinh, khế ước) xung đột với bản địa → tạo conflict + cơ hội, KHÔNG smooth tuyệt đối.',
    '  • Callback ≥1/arc: MC nhớ về thế giới cũ (người thân, công việc, lý do muốn về hoặc chấp nhận ở lại).',
  ],
  'xuyen-khong': [
    'XUYÊN KHÔNG PATTERNS (穿空 — xuyên vào sách/game/thế giới đã biết, leverage = CANON KNOWLEDGE biết trước cốt truyện):',
    '  • Canon foreknowledge = golden finger: MC biết trước plot gốc (nhân vật nào phản, kiếp nạn nào tới, bảo vật ở đâu) → mỗi 1-2 chương 1 lần dùng kiến thức canon để đón đầu.',
    '  • Trigger = mốc cốt truyện: gặp nhân vật canon / tới địa điểm canon / sắp tới sự kiện canon → 1-2 câu MC nhận ra "đây là đoạn X trong nguyên tác" → hành động khác.',
    '  • BUTTERFLY EFFECT bắt buộc: MC can thiệp → cốt truyện LỆCH khỏi canon → kiến thức biết-trước MẤT GIÁ DẦN. Càng về sau MC càng phải tự xoay sở vì timeline đã đổi. Đây là cost cốt lõi, CẤM "MC biết hết tới chương cuối".',
    '  • Vai trò trong canon: MC thường là nhân vật phụ/pháo hôi/phản diện trong nguyên tác → dùng foreknowledge để đổi vận mệnh nhân vật mình nhập vào (cứu, né chết, đoạt cơ duyên của main gốc).',
    '  • Anti-overpowered: MC chỉ nhớ KEY PLOT, không nhớ chi tiết vụn (lời thoại chính xác, ngày giờ cụ thể). Nhân vật canon vẫn có ý chí riêng → có thể hành động ngoài dự đoán khi MC đã làm họ lệch.',
    '  • Cover story: MC giải thích khả năng tiên đoán bằng "linh cảm / xem tướng / mộng báo" — KHÔNG để người canon nghi ngờ MC biết "tương lai kịch bản".',
    '  • Callback ≥1/arc: đối chiếu hiện tại với canon gốc — "đáng lẽ đoạn này X chết, giờ vì ta nên khác rồi".',
  ],
  'kinh-doanh': [
    'KINH DOANH PATTERNS:',
