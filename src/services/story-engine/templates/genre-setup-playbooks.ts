...
const TIEN_HIEP: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['tien-hiep'],
      antiPatterns: ['quá rập khuôn truyền thống không đổi mới', 'coi thường pháp môn hiện đại của tông môn khác chỉ vì khác truyền thừa'],
    },
  ],
  openingScenes: [
    {
...
const DO_THI: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['do-thi'],
      antiPatterns: ['thành công nhờ may mắn không nhờ năng lực', 'hạ gục đối thủ kỳ cựu chỉ sau một đêm không qua quá trình học hỏi'],
    },
    {
      name: 'CEO tương lai',
...
const KIEM_HIEP: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['kiem-hiep'],
      antiPatterns: ['lộ võ công quá sớm khi không cần', 'bị làm nhục công khai kéo dài chỉ để giấu thân phận'],
    },
    {
      ...
      fits: ['kiem-hiep'],
      antiPatterns: ['cải tà rồi lại quay lại ma đạo không lý do', 'bị cả hai phe truy sát dồn vào đường cùng ngay ch.1'],
    },
    {
      ...
      fits: ['kiem-hiep'],
      antiPatterns: ['lộ thân phận quá sớm vì lý do nhẹ', 'bị khách quán trọ đánh đập làm nhục để câu drama'],
    },
    {
      ...
      fits: ['kiem-hiep'],
      antiPatterns: ['mất hết người thân ngay ch.1', 'chìm trong đau thương quá khứ thay vì hành động phục hưng'],
    },
  ],
  openingScenes: [
    {
...
const LICH_SU: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['lich-su'],
      antiPatterns: ['triều đình cấm hết, không thể làm gì', 'thua trận mở màn thảm hại chỉ để tạo motivation'],
    },
    {
    ...
    },
    {
      ...
      fits: ['lich-su'],
      antiPatterns: ['phục thù toàn diện ngay khi vừa hồi phục thân phận', 'sống đói khổ cùng cực trong những chương đầu'],
    },
    {
      ...
      fits: ['lich-su'],
      antiPatterns: ['bị triều đình tịch thu hết tài sản', 'khởi nghiệp từ hai bàn tay trắng đói rách ch.1'],
    },
    {
      name: 'nho gia cải tổ',
      ...
      fits: ['lich-su'],
      antiPatterns: ['bị tử hình vì tà thuyết', 'bị cả triều đình cô lập không một đồng minh'],
    },
  ],
  openingScenes: [
    {
...
const KHOA_HUYEN: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['khoa-huyen'],
      antiPatterns: ['startup phá sản ngay ch.1', 'bị nhà đầu tư chèn ép mất quyền kiểm soát ngay đầu truyện'],
    },
    {
      name: 'hacker ẩn danh',
      ...
      fits: ['khoa-huyen'],
      antiPatterns: ['phạm tội nặng nhưng không hậu quả', 'bị truy bắt chạy trốn xuyên suốt Phase 1'],
    },
    {
      ...
      fits: ['khoa-huyen'],
      antiPatterns: ['data đột nhiên bị xóa không lý do', 'insight đúng nhưng không ai tin suốt nhiều chương liền'],
    },
    {
      ...
      fits: ['khoa-huyen'],
      antiPatterns: ['bệnh nhân chết để tạo motivation', 'nghiên cứu bị đánh cắp trắng trợn ngay khi vừa công bố'],
    },
  ],
  openingScenes: [
    {
  ...
  mcArchetypes: [
    {
      ...
      fits: ['vong-du'],
      antiPatterns: ['lộ ID quá sớm để bị chú ý', 'bị guild cũ phản bội dồn vào thế khốn cùng ch.1'],
    },
    {
      ...
      fits: ['vong-du'],
      antiPatterns: ['gia đình tan vỡ vì game', 'nợ nần chồng chất đói ăn trước khi game cứu vớt'],
    },
    {
      ...
      fits: ['vong-du'],
      antiPatterns: ['lộ kiến thức tương lai làm các player khác nghi', 'dành cả Phase 1 báo thù kẻ hại kiếp trước'],
    },
    {
      ...
      fits: ['vong-du'],
      antiPatterns: ['exploit nặng đến mức bị ban', 'thắng toàn bộ nhờ bug không nhờ kỹ năng thực'],
    },
    {
      ...
      fits: ['vong-du'],
      antiPatterns: ['guild tan rã không lý do', 'bị phó hội trưởng phản bội cướp guild ngay đầu truyện'],
    },
    {
      ...
      fits: ['vong-du'],
      antiPatterns: ['scandal phá sự nghiệp', 'view tăng nhờ drama dàn dựng thay vì thực lực chơi game'],
    },
  ],
  openingScenes: [
    {
...
const DONG_NHAN: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['dong-nhan'],
      antiPatterns: ['mentor chết để tạo angst', 'cướp spotlight làm lu mờ protagonist canon hoàn toàn'],
    },
    {
      ...
      fits: ['dong-nhan'],
      antiPatterns: ['side char bị coi thường vĩnh viễn', 'đi lại y nguyên cốt truyện canon không thay đổi gì'],
    },
    {
      ...
      fits: ['dong-nhan'],
      antiPatterns: ['antagonist quay đầu quá nhanh không lý do', 'bị cả thế giới canon truy sát ngay từ ch.1'],
    },
    {
      ...
      fits: ['dong-nhan'],
      antiPatterns: ['butterfly effect biến canon thành chaos không control được', 'spoil toàn bộ plot tương lai cho nhân vật canon'],
    },
  ],
  openingScenes: [
    {
...
const MAT_THE: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['mat-the'],
      antiPatterns: ['power gây hủy diệt vô lý', 'che giấu power đến mức người thân gặp nguy không cứu'],
    },
    {
      ...
      fits: ['mat-the'],
      antiPatterns: ['lộ kiến thức apocalypse với người không tin', 'dành Phase 1 báo thù kẻ hại kiếp trước thay vì xây dựng'],
    },
    {
    ...
    },
    {
      ...
      fits: ['mat-the'],
      antiPatterns: ['cộng đồng tan rã do nội phản', 'thánh mẫu thu nhận mọi kẻ khả nghi không sàng lọc'],
    },
    {
      name: 'lone hunter',
      ...
      fits: ['mat-the'],
      antiPatterns: ['sociopath không có ethics', 'từ chối mọi giao tiếp xã hội đến mức truyện không có cast phụ'],
    },
  ],
  openingScenes: [
    {
...
const LINH_DI: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['linh-di'],
      antiPatterns: ['không tin gì spirit ngay khi gặp', 'liều mạng vào hung địa không chuẩn bị thiết bị'],
    },
    {
      ...
      fits: ['linh-di'],
      antiPatterns: ['power overwhelming MC liên tục', 'bị spirit chiếm xác mất kiểm soát kéo dài nhiều chương'],
    },
    {
      ...
      fits: ['linh-di'],
      antiPatterns: ['xem nhẹ spirit case', 'bị cảnh sát nghi oan là hung thủ chỉ để tạo drama'],
    },
    {
      ...
      fits: ['linh-di'],
      antiPatterns: ['phá cấm kỵ vì lý do nhỏ', 'rập khuôn sách cổ không ứng biến theo từng case'],
    },
    {
      ...
      fits: ['linh-di'],
      antiPatterns: ['power awaken quá nhanh không learning curve', 'panic la hét kéo dài qua nhiều scene liên tiếp'],
    },
  ],
  openingScenes: [
    {
...
const QUAN_TRUONG: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['quan-truong'],
      antiPatterns: ['lộ kiến thức tương lai làm cấp trên nghi', 'dành Phase 1 trả thù kẻ hại kiếp trước thay vì làm việc thực'],
    },
    {
      ...
      fits: ['quan-truong'],
      antiPatterns: ['không thích nghi với chính trị', 'coi thường mọi quan chức xuất thân chính trị thuần túy'],
    },
    {
      name: 'thái tử đảng',
    ...
    },
    {
      ...
      fits: ['quan-truong'],
      antiPatterns: ['phụ thuộc 1 đại quan duy nhất', 'luồn cúi nịnh bợ thay vì thăng tiến bằng thực lực'],
    },
    {
      ...
      fits: ['quan-truong'],
      antiPatterns: ['cải cách quá nhanh bị backlash', 'thuyết giảng đạo đức dài dòng thay vì hành động cụ thể'],
    },
  ],
  openingScenes: [
    {
...
const DI_GIOI: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['di-gioi'],
      antiPatterns: ['mất lãnh thổ ngay ch.1', 'dân chúng nổi loạn đói kém ngay những chương đầu'],
    },
    {
      ...
      fits: ['di-gioi'],
      antiPatterns: ['party tan rã', 'bị đồng đội phản bội bỏ rơi trong dungeon ch.1'],
    },
    {
      ...
      fits: ['di-gioi'],
      antiPatterns: ['professor ghen tị steal credit', 'bị học viện trù dập đuổi học chỉ để tạo drama'],
    },
    {
      ...
      fits: ['di-gioi'],
      antiPatterns: ['guild độc quyền chèn ép', 'khởi đầu nợ nần đói rách phải bán đồ gia truyền'],
    },
    {
      ...
      fits: ['di-gioi'],
      antiPatterns: ['church corruption đè nặng', 'thánh mẫu cứu cả kẻ thù vừa hãm hại mình'],
    },
  ],
  openingScenes: [
    {
...
const NGON_TINH: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['ngon-tinh'],
      antiPatterns: ['phục thù người yêu cũ ngay ch.1', 'sa lầy đấu tiểu tam chiếm toàn bộ Phase 1'],
    },
    {
      ...
      fits: ['ngon-tinh'],
      antiPatterns: ['art bị đánh cắp', 'bị gia đình ép bỏ nghề cắt viện trợ ngay ch.1'],
    },
    {
    ...
    },
    {
      ...
      fits: ['ngon-tinh'],
      antiPatterns: ['lộ thân phận quá sớm', 'bị họ hàng khinh thường chà đạp kéo dài để câu drama'],
    },
    {
      ...
      fits: ['ngon-tinh'],
      antiPatterns: ['scandal phá sự nghiệp ngay', 'bị nghệ sĩ mình quản lý phản bội ngay đầu truyện'],
    },
  ],
  openingScenes: [
    {
...
const QUY_TAC_QUAI_DAM: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['quy-tac-quai-dam'],
      antiPatterns: ['ignore intuition', 'phân tích dài dòng đứng yên khi quy tắc đang đếm ngược'],
    },
    {
      ...
      fits: ['quy-tac-quai-dam'],
      antiPatterns: ['quá tự tin sau 1-2 phó bản thắng', 'sống sót nhờ may mắn thay vì suy luận quy tắc'],
    },
    {
      ...
      fits: ['quy-tac-quai-dam'],
      antiPatterns: ['team tan rã do conflict', 'hy sinh đồng đội như tốt thí không chút day dứt'],
    },
    {
      ...
      fits: ['quy-tac-quai-dam'],
      antiPatterns: ['power overwhelming', 'dựa hoàn toàn vào giác quan bỏ qua suy luận quy tắc'],
    },
    {
      ...
      fits: ['quy-tac-quai-dam'],
      antiPatterns: ['greed làm chết người', 'vật phẩm toàn năng giải quyết được mọi phó bản'],
    },
  ],
  openingScenes: [
    {
...
const NGU_THU_TIEN_HOA: GenreSetupPlaybook = {
  ...
  mcArchetypes: [
    ...
    },
    {
      ...
      fits: ['ngu-thu-tien-hoa'],
      antiPatterns: ['pet abuse', 'pet phản chủ bỏ đi chỉ để tạo angst'],
    },
    {
      ...
      fits: ['ngu-thu-tien-hoa'],
      antiPatterns: ['rập khuôn truyền thống', 'mất pet truyền thừa ngay ch.1 để tạo motivation'],
    },
    {
      ...
      fits: ['ngu-thu-tien-hoa'],
      antiPatterns: ['ignore intuition pet', 'biến pet thành vật thí nghiệm vô cảm'],
    },
    {
      name: 'explorer + tamer',
      ...
      fits: ['ngu-thu-tien-hoa'],
      antiPatterns: ['poaching', 'lạc trong cấm khu đói khát kéo dài nhiều chương'],
    },
    {
      ...
      fits: ['ngu-thu-tien-hoa'],
      antiPatterns: ['black market exploit', 'bị hiệp hội tịch thu toàn bộ pet ngay đầu truyện'],
    },
  ],
  openingScenes: [
    {
  ...
  mcArchetypes: [
    {
      ...
      fits: ['khoai-xuyen'],
      antiPatterns: ['ignore variation từng world', 'xem nguyên chủ như công cụ không tôn trọng nguyện vọng'],
    },
    {
      ...
      fits: ['khoai-xuyen'],
      antiPatterns: ['quá tự tin sau 1-2 worlds', 'phá hỏng mission đầu chỉ để dạy MC bài học khiêm tốn'],
    },
    {
      name: 'rebel hệ thống',
      ...
      fits: ['khoai-xuyen'],
      antiPatterns: ['rebel quá rõ bị hệ thống ban', 'phá mission vô tội vạ khiến nguyên chủ chịu thiệt'],
    },
    {
      ...
      fits: ['khoai-xuyen'],
      antiPatterns: ['partner phản bội', 'ngọt ngào sến súa lấn át nhiệm vụ chính của world'],
    },
    {
      ...
      fits: ['khoai-xuyen'],
      antiPatterns: ['greed làm hỏng mission', 'farm skill bỏ mặc nguyện vọng của nguyên chủ'],
    },
    {
      ...
      fits: ['khoai-xuyen'],
      antiPatterns: ['ignore mission để chase meta', 'reveal toàn bộ chân tướng hệ thống quá sớm'],
    },
  ],
  openingScenes: [
    {
