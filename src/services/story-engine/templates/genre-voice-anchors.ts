...
const ANCHORS: Record<GenreType, VoiceAnchor> = {
  ...
  'tien-hiep': {
    ...
    voiceAnchor: `<MC> mở mắt. Đan điền trống rỗng — không một sợi linh khí. Hắn ngồi dậy trên giường gỗ cũ, đưa tay sờ ngực: trái tim còn đập, nhưng huyết mạch chậm như nước đông.\n\nNgoài cửa sổ, sương sớm phủ trên đỉnh núi Thanh Vân. Đệ tử ngoại môn đã ra sân tập kiếm. Tiếng kim loại va vào nhau lạnh buốt, đều đặn như nhịp tim của ai đó còn sống.\n\nHắn nhìn xuống bàn tay. Da gầy, ngón thon — không phải tay người luyện võ. Trí nhớ của thân thể này từ từ trào lên: con thứ ba của Tô gia, ba lần thi nhập môn đều rớt, vừa qua đời tối qua vì uất ức. <MC> — kiếp trước Kim Đan trưởng lão, kiếp này phế đan điền.\n\nHắn khẽ cười. Một nụ cười không có ý nghĩa với bất kỳ ai khác.\n\n— Phế đan điền hay không, ta cũng đã từng đăng đỉnh.`,
    chapterOneHook: `<MC> mở mắt giữa tiếng chuông sớm của núi Thanh Vân. Đan điền trống rỗng — phế nhân. Nhưng trí nhớ tu tiên của kiếp trước, hắn vẫn nhớ rõ từng đường vận khí, từng lò đan, từng kẻ đã hại mình ba trăm năm trước.`,
    dopamineMoment: `Trưởng lão Lý Bình nhặt viên đan dược lên, nhăn mày: "Đan này... phẩm tam phẩm, nhưng dược lực vượt qua tứ phẩm." Lão nhìn <MC>, ánh mắt từ khinh thường chuyển thành nghi hoặc — không, là hoảng hốt. "Ngươi... ngươi nói ngươi tự luyện?"\n<MC> gật đầu, không giải thích thêm.`,
  },

  'kiem-hiep': {
    voiceNotes: 'Giang hồ + nghĩa khí. Câu chắc, hành động cụ thể. Ít tu tiên jargon, nhiều "chiêu thức/võ công". Khí khái cao.',
    voiceAnchor: `<MC> đặt vò rượu xuống mép bàn, ngón tay khẽ gõ ba tiếng. Quán trọ Bạch Vân chiều mưa thưa khách. Ngoài cửa, vó ngựa bùn lép nhép — bốn người, kiếm dài đeo lưng, áo đen.\n\nTiểu nhị nuốt nước bọt: "Khách quan, có lẽ ngài nên đi cửa sau."\n\n<MC> rót cho mình một chén. Rượu Trúc Diệp Thanh, vị nhạt, hơi đắng. Hắn uống cạn, đặt chén xuống.\n\n— Cửa sau ướt. Ta đi cửa trước.\n\nKhi bốn người áo đen đẩy cửa bước vào, tay đã đặt trên chuôi kiếm. Người đứng đầu lên tiếng, giọng khàn:\n\n— Tiểu Lý phi đao, Tô đại ca cho người gửi ngươi mấy lời.\n\n<MC> cười, không đáp. Tay phải hắn vẫn cầm chén rượu. Tay trái không thấy đâu.`,
    chapterOneHook: `Mưa gió quán Bạch Vân, <MC> ngồi một mình uống rượu. Bốn kiếm khách áo đen vừa đẩy cửa vào — chưa kịp rút kiếm, ba người đã ngã xuống. Phi đao của hắn nhanh đến mức cả tiếng gió cũng chưa kịp vang lên.`,
    dopamineMoment: `Tô Hữu Bằng nhìn lưỡi đao găm vào cột gỗ, cách cổ mình đúng một thốn. Tay run, mồ hôi lạnh chảy dọc sống lưng. <MC> đã đứng dậy, uống chén rượu cuối cùng:\n— Đao thứ hai sẽ không trật.\nCả tửu lâu im phăng phắc.`,
  },
  ...
  'quan-truong': {
    ...
    voiceAnchor: `Phòng Phó Bí Thư Huyện Ủy lúc tám giờ sáng. Cửa khép, điều hòa hai mươi lăm độ, trên bàn ba bộ hồ sơ và một ấm trà sen Tây Hồ.\n\n<MC> đặt cuốn báo cáo xuống mặt bàn, nhìn thẳng vào Bí Thư Trần Hải.\n\n— Anh Hải, vụ đất Khu Công Nghiệp Đông Sơn — em đã đọc kỹ. Có ba điểm.\n\nTrần Hải rót trà, không ngẩng đầu:\n— Ba điểm gì?\n\n— Thứ nhất, định giá đất chênh ba mươi phần trăm so với thị trường. Thứ hai, công ty trúng thầu mới thành lập sáu tháng, chưa có dự án tham chiếu. Thứ ba — <MC> dừng, gập tay — chữ ký phê duyệt của em là chữ ký giả.\n\nKhông gian im lặng. Trần Hải đặt ly trà xuống, từ tốn. Mép môi co một chút.\n\n— <MC> à, em mới về huyện sáu tháng. Có những việc... em chưa hiểu hết.\n\n<MC> đứng dậy, gật đầu:\n— Em hiểu. Nhưng em đã gửi báo cáo lên Tỉnh Ủy lúc bảy giờ sáng nay.`,
    chapterOneHook: `<MC> nhậm chức Phó Bí Thư Huyện Sơn Đông tuần trước. Sáng nay, hắn phát hiện chữ ký giả trong hồ sơ đất Khu Công Nghiệp — ký tên chính Bí Thư Huyện. Bảy giờ sáng, báo cáo đã lên đến Tỉnh.`,
    dopamineMoment: `Cuộc họp Thường Vụ. Tỉnh Ủy gọi tên <MC> trước hội đồng:\n— Đồng chí <MC>, báo cáo Đông Sơn của đồng chí — chính xác từng con số, từng chữ ký. Tỉnh ủy quyết định: thanh tra toàn diện huyện Sơn Đông, bắt đầu hôm nay.\nTrần Hải ngồi đối diện, mặt không biểu cảm. Nhưng tay phải gõ nhẹ ba lần lên bàn.`,
  },

  // ── HISTORICAL ───────────────────────────────────────────────────────────
  'lich-su': {
    voiceNotes: 'Cổ phong văn ngôn. Câu dài, dùng "trẫm/khanh/thần/chức". Triều đình + cung đấu + chiến lược. Chậm, nặng nề.',
    voiceAnchor: `Năm Càn Long thứ mười bảy, <MC> từ Hàn Lâm Viện về phủ Thượng Thư. Trời tháng chín Bắc Kinh, lá ngô đồng vàng rụng đầy ngõ.\n\nNgạn vén áo bước vào thư phòng cha. Tô Đại Học Sĩ — Tô Bá Khắc — đang viết tấu chương, không ngẩng đầu:\n— Hôm nay vào triều, Hoàng Thượng có hỏi về vụ Hà Bắc?\n\n— Có. — Ngạn cúi người chào, đứng tránh hai bước — Hoàng Thượng hỏi: "Tô khanh trẻ tuổi, ngươi nghĩ thế nào?"\n\nTô Bá Khắc đặt bút xuống. Lần đầu trong ba ngày, lão nhìn con trai trực diện.\n\n— Ngươi đáp gì?\n\n— Thần đáp: Thiên hạ chi sự, không ở Hà Bắc một châu. Ở chỗ thuế đất chưa định, quan binh chưa luyện, lương thảo chưa đủ.\n\nMột khoảnh khắc dài. Rồi Tô Bá Khắc cười khẽ:\n— Ngươi nói câu đó trước Hoàng Thượng?\n\n— Vâng.\n\n— Vậy là ngươi đã quyết định đứng về phe Hòa Thân rồi. Tốt. Cha vẫn còn cứu được ngươi.`,
    chapterOneHook: `Năm Càn Long thứ mười bảy, <MC> — tân khoa Trạng Nguyên — vào triều ngày đầu tiên. Hoàng Thượng hỏi về Hà Bắc, hắn đáp một câu ngắn — đủ để cha hắn, Đại Học Sĩ Tô Bá Khắc, hiểu rằng đứa con trai đã chọn phe.`,
    dopamineMoment: `Hoàng Thượng đọc tấu chương của <MC>, ngẩng đầu nhìn Hòa Thân, cười:\n— Hòa Khanh, Tô khanh đề xuất pháp Quân Điền cải lương. Khanh đọc kỹ chưa?\nHòa Thân cúi đầu:\n— Thần đã đọc. Sách lược... thiên hạ vô song.\nMặt lão tái đi một chút. <MC> đứng phía sau, không cười.`,
  },

  // ── SCI-FI ───────────────────────────────────────────────────────────────
  'khoa-huyen': {
    voiceNotes: 'Khoa học + viễn tưởng. Hard sci-fi terms cụ thể. AI/lab/tech corp. Ít tu tiên, nhiều kỹ thuật. Câu chính xác.',
    voiceAnchor: `Phòng Lab 7, Tầng B3, Viện Nghiên Cứu Sinh Học Phượng Đô. Hai giờ sáng, đèn LED trắng. <MC> nhìn vào màn hình hiển vi điện tử — phân tử CRISPR-Cas9 cải tiến đang gắn vào sợi DNA chuột thí nghiệm.\n\nThời gian gắn: 0.003 giây. Hiệu suất: 99.7%.\n\nKỷ lục thế giới hiện tại: 0.04 giây, 78%.\n\nHắn không ăn mừng. Chỉ ghi vào sổ tay: *Lần thứ 41. Thành công.* Đóng nắp.\n\nĐiện thoại rung. Tin nhắn từ Giáo sư Lê: "Hạo, Mỹ vừa công bố — họ đạt 0.05 giây, 80%. Báo chí đang gọi đó là đột phá thế kỷ. Chúc mừng họ."\n\n<MC> nhìn dòng tin, không đáp. Hắn lưu kết quả vào ổ cứng cá nhân, mã hóa hai lớp. Rồi bật ứng dụng *Hệ Thống Khoa Học* trên điện thoại — giao diện tối giản, không quảng cáo. Trên màn hình, một thông báo:\n\n*Phát hiện đối thủ tiềm năng. Đề xuất công bố nghiên cứu công khai để chiếm thế dẫn đầu? [Có / Không]*\n\nHắn chọn Không. Còn quá sớm.`,
    chapterOneHook: `Hai giờ sáng phòng lab Viện Phượng Đô, <MC> vừa hoàn thành lần thí nghiệm thứ 41 — gắn CRISPR vào DNA chuột trong 0.003 giây, hiệu suất 99.7%. Cả thế giới chưa ai đạt nổi 0.05 giây. Hệ thống trong điện thoại hắn nháy: "Đề xuất giấu kỹ — chưa phải lúc."`,
    dopamineMoment: `Hội nghị Nature Genetics, San Francisco. Đại diện MIT đứng dậy:\n— Tôi muốn hỏi tác giả paper "Sub-millisecond CRISPR" — chỉ số 99.7% có thật không? Đây là... không thể.\n<MC>, hai mươi sáu tuổi, cười nhẹ qua màn hình. Không đáp. Hắn click chuột. Trên slide hiện ra video real-time — thí nghiệm đang chạy live tại Phượng Đô.\nCả phòng họp 3000 người im phăng phắc.`,
  },

  // ── GAMING ───────────────────────────────────────────────────────────────
  'vong-du': {
    voiceNotes: 'VR full-immersion (helmet/cabin "thế giới thứ hai") + IRL impact mạnh. Mỗi chương BLEND in-game + IRL scene. Sensory transition khi login. Stat numbers + IRL stakes (sponsor, fame, family pressure).',
    voiceAnchor: `<MC> đặt cabin pod xuống sàn phòng trọ. Năm centimet là khoảng đi qua còn lại. Tiền thuê tháng này ăn hết sponsor đầu tay — bốn triệu. Đáng.\n\nMũ helmet bao kín đầu. Gel sync làm da đầu lạnh.\n\n*Đăng nhập Cửu Châu Online... 3... 2... 1...*\n\nCăn phòng tan ra. Gió núi Hắc Lâm Vực đập vào mặt. Mùi tùng. Tiếng ngựa party đối thủ xa.\n\nTài khoản "Vô Danh Kiếm Khách", lvl 47, không guild. Cổng Boss Hắc Long — wiki nói cần party 8 lvl 60+, drop legendary 2%.\n\n<MC> đứng một mình.\n\n— Đóng pop-up cảnh báo. — hắn lẩm bẩm vào tai nghe — Stream đang quay 12 ngàn viewer.\n\nPing 18ms. Cooldown 0s. Kỹ năng ẩn "Phản Sát" wiki chưa biết.\n\nHP 100% → 50% → 10% → 1%.\n\n*[Phản Sát — sát thương x100]*\n\nServer announcement nháy đỏ. Stream chat bùng nổ. Notification: "Sponsor Anh Long chuyển 50 triệu."`,
    chapterOneHook: `<MC>, sinh viên Bách Khoa, dồn 4 triệu vào cabin VR. Login Cửu Châu Online — solo Boss Hắc Long wiki nói cần 8 người. Stream 12k viewer. Sponsor chuyển 50 triệu. Bố ở quê chưa biết.`,
    dopamineMoment: `Logout cabin. Điện thoại 47 tin nhắn. Guild Master "Thiên Hạ Vô Địch" gọi: "Brother, club tôi mời pro contract 200 triệu/tháng, bao cabin Pro tier."\n<MC> mở Excel học phí kỳ tới.\n— Anh cho em 24 giờ suy nghĩ.\nNgắt máy. Group phòng trọ: "Mai em mời cả nhà ăn lẩu."`,
  },

  // ── FAN-FIC ──────────────────────────────────────────────────────────────
  'dong-nhan': {
    voiceNotes: 'Tham chiếu IP gốc. Voice tự sự + meta. Reference original characters. Parallel canon timeline.',
    voiceAnchor: `Năm 1999, Konoha. <MC> mở mắt trong thân xác đứa trẻ tám tuổi tên <MC> — cousin đời của Hatake Kakashi mà mọi fan Naruto đều biết.\n\nTrong trí nhớ kiếp trước, hắn là sinh viên Đại Học Bách Khoa, chuyên ngành Cơ Khí. Đột tử vì làm việc 18 tiếng liên tục.\n\nThân xác mới, sáu tuổi vào Học Viện Nhẫn Giả. Genetic Hatake — Sharingan ẩn, chakra thuần.\n\nNhưng thứ hắn quan tâm không phải Sharingan. Mà là — hắn nhớ rõ canon. Năm sau, Uchiha Itachi sẽ thảm sát toàn tộc Uchiha. Hai năm nữa, Sasuke sẽ bị bỏ lại một mình. Mười năm nữa, Pain sẽ phá hủy Konoha.\n\nVà hắn — <MC> — có 10 năm để chuẩn bị.\n\n*Hệ thống Trí Thức Cơ Khí Hiện Đại — đã đồng bộ.*\n\nHắn cười khẽ. Konoha sẽ không còn yếu nữa.`,
    chapterOneHook: `<MC> xuyên không vào thân <MC> — em họ Kakashi trong Naruto canon, tám tuổi. Hắn nhớ rõ: một năm nữa thảm sát Uchiha. Hắn có hệ thống cơ khí hiện đại + 10 năm chuẩn bị + một câu hỏi duy nhất: cứu hay không?`,
    dopamineMoment: `Uchiha Itachi sáu tuổi nhìn thí nghiệm máy điện từ của <MC> — bóng đèn sáng từ pin tự chế, không cần chakra.\n— Anh... — Itachi hiếm khi gọi ai bằng "anh" — anh dạy em được không?\n<MC> gật đầu:\n— Được. Nhưng có điều kiện. Anh dạy em — em không được giết tộc mình.\nÁnh mắt Itachi run nhẹ.`,
  },

  // ── APOCALYPSE ───────────────────────────────────────────────────────────
  'mat-the': {
    voiceNotes: 'Sinh tồn + tài nguyên khan hiếm. Câu ngắn, gritty. Time pressure. Đếm số (lon nước, viên đạn, ngày sống sót).',
    voiceAnchor: `Ngày 47 sau khi mặt trời tắt.\n\n<MC> kiểm tra kho ngầm Phượng Đô lần thứ ba trong ngày. 1,247 lon thức ăn đóng hộp. 320 lít nước lọc. 47 viên đạn shotgun. 3 đèn pin chạy năng lượng mặt trời — vô dụng kể từ ngày 47.\n\nNgoài cửa hầm, gió rít qua lỗ thông gió. Nhiệt độ ngoài: âm 12 độ.\n\nHắn ngồi xuống, mở app *Hệ Thống Trữ Tài Nguyên* — thứ duy nhất chạy được trên điện thoại tự cấp pin từ thân nhiệt.\n\n*Cảnh báo: Có chuyển động trong vòng 200m. 3 thực thể.*\n\nHắn rút súng, lên đạn. Thực thể — không phải người. Sau ngày thứ 30, mặt người đã quên cách ấm.\n\nGõ cửa. Một tiếng. Hai tiếng. Ba tiếng — cách đều, cố tình.\n\nHắn dừng. Người. Còn người.\n\n— Là ai? — hắn gọi qua loa, súng vẫn lên đạn.\n\n— Cô gái ngày thứ ba mươi anh cứu ngoài siêu thị Big C. Tên Linh.`,
    chapterOneHook: `Ngày 47 mặt trời tắt, nhiệt độ âm 12 độ. <MC> trong hầm Phượng Đô — 1,247 lon, 320 lít nước, 47 viên đạn. Hệ thống nháy: "3 thực thể đang đến." Một trong số đó gõ cửa đúng nhịp con người.`,
    dopamineMoment: `<MC> mở van bể nước cho 12 người sống sót. Trưởng nhóm gangster Trọng cười nhếch:\n— Anh thật ngu, cho người ngoài uống nước của mình.\n<MC> rót cho mình một ly nhỏ:\n— Tôi tính rồi. 12 người, 320 lít, dùng đến mùa xuân. Anh tính được 320 chia 12 là bao nhiêu không?\nTrọng cứng họng. Cả bàn nhìn hắn.`,
  },

  // ── HORROR ───────────────────────────────────────────────────────────────
  'linh-di': {
    voiceNotes: 'Không khí ngột ngạt. Câu ngắn-dài xen kẽ. Thị giác tối + thính giác sắc. Reveal chậm. Cấm jumpscare cliché.',
    voiceAnchor: `Ngỗ tác <MC> nhận xác lúc một giờ sáng. Cô gái, hai mươi mốt tuổi, tử vong cách đây sáu giờ. Vết thương — không có. Không vết bầm, không vết cào, không dấu siết cổ.\n\nNhưng mắt cô — mở. Tròng đen co lại bằng đầu kim.\n\nPhòng giải phẫu chỉ có hai bóng đèn. Một bóng phía trên bàn mổ — sáng. Một bóng góc phòng — chập chờn.\n\n<MC> đeo găng. Lấy dao mổ. Bắt đầu cắt từ đầu xương ức.\n\nDưới lớp da, không phải mô tim người thường. Là — đất. Đất đen, ẩm, có rễ cỏ.\n\nHắn dừng dao. Hít một hơi.\n\nTrong phòng, đèn góc phòng tắt hẳn. Bóng đèn còn lại bắt đầu chập chờn theo nhịp tim của ai đó — không phải hắn, không phải xác.\n\nĐiện thoại rung trong túi. Tin nhắn không rõ số:\n*"Đừng cắt tiếp. Chôn lại."*\n\n<MC> rút dao ra khỏi xác. Nhìn lên trần nhà.\n\nTrần nhà có một dấu chân — hướng xuống.`,
    chapterOneHook: `Một giờ sáng phòng giải phẫu sông Hương, ngỗ tác <MC> rạch xác cô gái — không thấy mô tim, chỉ thấy đất đen có rễ cỏ. Đèn vụt tắt. Tin nhắn từ số lạ: "Đừng cắt tiếp. Chôn lại."`,
    dopamineMoment: `<MC> gặp lại cô gái — sống — ba ngày sau, ngoài chợ. Cô đi qua không nhận ra hắn. Trên cổ tay, vẫn có hình xăm mà hắn đã thấy trên xác.\nHắn không hét. Không hỏi. Chỉ rút điện thoại, mở ghi âm:\n— Ngày bốn tháng tư, lần đầu tiên tôi gặp một người chết hai lần.`,
  },

  // ── ISEKAI ───────────────────────────────────────────────────────────────
  'di-gioi': {
    voiceNotes: 'Modern knowledge gap. Culture clash. Tech uplift / business / lord-building. MC has goal cụ thể, không lan man.',
    voiceAnchor: `<MC> tỉnh dậy trong rừng Cấm Trung Đại Lục, trên người chỉ có áo phông Bách Khoa và một chiếc điện thoại cạn pin.\n\nTrời sáng rõ rồi. Tiếng chim lạ kêu. Cây có lá tím — không phải Trái Đất.\n\nHắn mở điện thoại. Hai phần trăm pin. Nhưng wifi tự kết nối — *Hệ Thống Tri Thức Hiện Đại* hiện lên. Database 47TB kiến thức nhân loại 2025. Offline.\n\nHắn cười. Vậy là pin không quan trọng nữa.\n\nĐi bộ ba tiếng, đến một thôn — Hoa Thôn. Lúa nước, ruộng bậc thang, một ngôi đền đá. Văn minh nông nghiệp, có lẽ tương đương Đường-Tống Trái Đất.\n\nHắn ngồi xuống bên bờ ruộng. Quan sát: nông dân cày bừa bằng trâu. Mất 12 giờ một mẫu. Trên Trái Đất, máy cày 30 phút.\n\nLần đầu tiên trong đời, hắn nghĩ: *Có lẽ ta sẽ thay đổi thế giới này. Bắt đầu từ một cái cày sắt.*`,
    chapterOneHook: `<MC> xuyên không vào rừng Cấm Trung Đại Lục, áo phông Bách Khoa, điện thoại cạn pin nhưng có Hệ Thống Tri Thức Hiện Đại 47TB offline. Đến Hoa Thôn lúc trưa, hắn quan sát nông dân cày bằng trâu — 12 giờ một mẫu. Bắt đầu từ một cái cày sắt.`,
    dopamineMoment: `Lý trưởng Hoa Thôn xem cày sắt mới của <MC>, mặt từ nghi ngờ chuyển thành kinh ngạc:\n— Thiếu hiệp, cái cày này... một mình ngươi cày được hai mẫu một ngày?\n<MC> gật đầu, không khoe.\n— Thôn ta có ba trăm mẫu. Năm nay sẽ thu hoạch gấp đôi năm ngoái.\nLý trưởng quỳ xuống. <MC> vội đỡ:\n— Bác đứng dậy. Tôi cần thuê thợ rèn.`,
  },
  ...
  'ngon-tinh': {
    ...
    voiceAnchor: `<MC> đứng trong tiền sảnh khách sạn Sheraton, váy lụa xanh nhạt, mưa tháng ba ngoài cửa kính rơi đều như nhịp tim đang bình tĩnh giả vờ.\n\nNăm năm. Đã năm năm rồi cô không gặp anh.\n\nThang máy mở. Một bóng người bước ra — vai rộng, áo vest đen, ô gập trong tay vẫn còn nhỏ giọt. Anh ngẩng đầu, ánh mắt va vào cô.\n\nNăm giây.\n\nKhông ai nói gì.\n\nRồi anh — <LOVE>, người đã từng hứa với cô năm hai mươi tuổi rằng "anh sẽ về" rồi biến mất một tuần sau lễ tốt nghiệp — bước đến. Đặt ô vào tay cô. Giọng trầm, nhẹ như chưa từng có năm năm:\n\n— Em ướt áo rồi. Cầm lấy.\n\nCô nhận. Không nhìn anh. Không cảm ơn.\n\nNhưng tay cô — tay cô đang run.`,
    chapterOneHook: `<MC> gặp lại <LOVE> sau năm năm — trong tiền sảnh Sheraton, một chiều mưa tháng ba. Anh không xin lỗi. Chỉ đặt cây ô của mình vào tay cô: "Em ướt áo rồi." Cô nhận, tay run, nhưng không nhìn anh.`,
    dopamineMoment: `<LOVE> gọi điện cho mẹ <MC>:\n— Cô à, cháu xin phép đến nhà thứ Bảy. Cháu... cháu cần xin lỗi cô và em Vy.\nMẹ cô lặng im một lúc:\n— Năm năm, cháu mới gọi điện. Vy đã quên cháu rồi.\n<LOVE> đáp, giọng vẫn trầm:\n— Cháu biết. Nhưng cháu chưa quên. Và cháu sẽ chờ đến khi em ấy nhớ lại.`,
  },
...
‼️ PLACEHOLDER SEMANTICS — ĐỌC KỸ TRƯỚC KHI VIẾT:
   ...
   - Voice anchor cung cấp: rhythm câu + register + vocabulary + dopamine pattern.
     KHÔNG cung cấp: plot / characters / setting (those come from context).

📖 GIỌNG VĂN MẪU (match nhịp + register + vocabulary, KHÔNG copy tên):
${a.voiceAnchor}
...
→ Khi viết, MATCH register + sentence rhythm + vocabulary của giọng văn mẫu.
   ...
   KHÔNG bao giờ leak chuỗi "<MC>" / "<LOVE>" / "<CITY>" vào output thực tế.
=== END VOICE ANCHOR ===`;
}
