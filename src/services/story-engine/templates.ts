...
export const SUB_GENRE_RULES: Record<string, string[]> = {
  ...
  'isekai-net-cafe': [
    ...
    '  • Net cafe progression ladder: Cấp 1 (10-20 PC cũ, mì gói + trà đá) → Cấp 2 (30-50 PC, ghế gaming, bán đồ ăn đa dạng) → Cấp 3 (80+ PC, gaming center, esports tournament + RẠP CHIẾU PHIM mini) → Cấp 4 (multi-floor entertainment empire — gaming + rạp + cafe + karaoke)',
    '  • F&B layer: bán đồ ăn quán net Việt Nam (mì Hảo Hảo, bánh mì kẹp, cơm tấm, trà sữa, hột vịt lộn, bia Heineken, Pepsi) — adapt với ingredient dị giới. Reader hoài cổ.',
    '  • Rạp chiếu phim arc: chiếu lại phim Earth từ media library cũ (Titanic, Matrix, Lord of the Rings, Tây Du Ký, Đất Phương Nam, K-drama) — power transfer qua phim',
    '  • Esports arc: tổ chức tournament trong dị giới với game có sẵn (LoL Cup, CS Championship) → 5 vương quốc cử team → streaming live qua quán net network',
    '  • MC physically yếu: dùng business smart + customer relationships, KHÔNG combat. Customer (hiệp sĩ/pháp sư) làm fight',
    '  • Cast 5-8 customer regulars: hiệp sĩ già nghiện CS 1.6, pháp sư trẻ chơi DotA, công chúa nghiện Audition, lord chơi WoW guild, bard học cover Trịnh Công Sơn — mỗi người có cuộc đời thay đổi nhờ Earth content',
    '  • Comedy ratio 60%: fish-out-of-water Aerithine reactions với mì gói, AC, đèn LED, internet, headset — phản ứng over-react',
    '  • MC KHÔNG quay về Earth (one-way isekai), permanently ở dị giới — KHÔNG dual-world parallel scenes',
    '  • Anti-tropes: KHÔNG MC develop game (làm game = thể loại khác), KHÔNG MC combat, KHÔNG harem (single love interest slow-burn), KHÔNG face-slap aristocrat (politics qua diplomacy)',
    '  • Tone: cozy + comedy + nostalgic. KHÔNG epic, KHÔNG combat-driven',
    '  • MC archetypes: (1) sinh viên IT kế thừa quán net ông ngoại bị xuyên không, (2) ex-net-cafe owner đóng cửa vì game online, (3) gamer hardcore xuyên với máy chủ cũ, (4) IT support tỉnh dậy thành chủ quán dị giới',
    '  • Top examples: 《我在异界开网吧》(canonical), 《异世界开网吧》, 《异界网吧救世主》, 《网吧客户都是异界大佬》, 《封神网吧》',
  ],
  'game-parallel-world': [
