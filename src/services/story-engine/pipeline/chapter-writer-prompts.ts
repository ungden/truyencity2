...
- BẮT BUỘC KHÔNG ĐƯỢC LÙI thời gian, và KHÔNG ĐƯỢC nhảy địa điểm giữa hành động mà thiếu transition. NHƯNG: nếu [Cliffhanger chương trước] là LỜI HẸN THỜI ĐIỂM TƯƠNG LAI (form b — vd "Sáng mai 7h, MC sẽ tới biệt thự gặp X"), thì Scene 1 chương này PHẢI time-skip TIẾN tới đúng thời điểm/địa điểm đã hẹn (sáng mai, tại biệt thự) — đó LÀ cách giải quyết cliffhanger ĐÚNG, KHÔNG phải nhảy trái phép. Chỉ khi cliffhanger là sự kiện ĐANG diễn ra (vd nửa đêm trong rừng vừa bị phục kích) thì Scene 1 mới phải bắt đầu ngay tại rừng đó lúc nửa đêm. Tóm lại: time-skip tiến tới mốc-hẹn = HỢP LỆ; teleport địa điểm không lý do hoặc lùi thời gian = CẤM.
...
- CẤM kết chương bằng các câu "ego declaration" template:
  • "Trò chơi / Ván cờ / Cuộc chiến / Cuộc phiêu lưu / Bước đi mới THỰC SỰ bắt đầu / mới THẬT SỰ bắt đầu / bây giờ mới bắt đầu"
  • "Hắn / Y / Cô / Nàng là [Tên MC], và đây là thế giới của hắn/y/cô/nàng"
  • "Đối với [Tên MC], đây chỉ mới là khởi đầu" / "Tương lai còn dài"
  • Bất kỳ câu cuối nào có pattern: "[MC] + [hành động tĩnh: nhếch môi / nắm chặt tay / nhìn xa xăm / khẽ cười] + tuyên ngôn vĩ mô về bản thân / vận mệnh / thế giới"
- Ending hook PHẢI là 1 trong 2:
  (a) EVENT cụ thể vừa xảy ra: nhân vật mới gõ cửa / điện thoại reo + tên người gọi / tin nhắn nhận được nội dung gì / vật phẩm rơi xuống bàn / deadline gõ vào màn hình…
  (b) DECISION cụ thể MC vừa quyết: "Sáng mai 7h, [MC] sẽ tới [địa điểm cụ thể] gặp [tên người cụ thể] để [làm gì cụ thể]" — tên + thời gian + hành động trong ch.N+1 phải rõ ràng.
- Reader test: đọc 3 câu cuối, người ta phải đoán được ch.N+1 sẽ MỞ BẰNG action gì cụ thể trong vòng 100 từ đầu.

D4-TER. CẤM TEMPLATE STATIC OPENING (mở chương N+1):
- CẤM mở chương bằng pattern: "[Ánh sáng / không khí / thời tiết / khung cảnh tả thiết lập] + [Tên MC] đứng / ngồi / nằm BẤT ĐỘNG + nhìn / quan sát / chăm chú / lặng lẽ + suy ngẫm / nhớ lại / cân nhắc".
...
- "Hắn / Y / Cô / Nàng là [Tên MC], và đây là thế giới của hắn/y/cô/nàng"
- "Đối với [Tên MC], đây chỉ mới là khởi đầu" / "Tương lai còn dài"
- Bất kỳ câu cuối nào pattern: "[MC] + [hành động tĩnh nhếch môi / nắm chặt tay / nhìn xa xăm] + tuyên ngôn vĩ mô về bản thân / vận mệnh / thế giới"

Ending PHẢI là: EVENT cụ thể vừa xảy ra (điện thoại reo + tên người gọi, tin nhắn nội dung gì, nhân vật mới gõ cửa, vật phẩm rơi xuống bàn…) HOẶC DECISION cụ thể của MC ("Sáng mai 7h tới X gặp Y làm Z").

CẤM mở chương bằng pattern static: "[Ánh sáng / không khí / thời tiết / khung cảnh tả thiết lập] + [Tên MC] đứng / ngồi / nằm BẤT ĐỘNG + nhìn / quan sát / chăm chú / lặng lẽ + suy ngẫm / nhớ lại / cân nhắc".

Opening 100 từ đầu PHẢI: MC đang ACTIVELY làm gì đó cụ thể — đi bước / mở cửa / gọi điện / gõ bàn phím / cầm vật gì / ra lệnh cho ai / viết câu nào / tính toán số gì / nhận điện thoại của ai / bước vào phòng nào. Tả cảnh tĩnh + nội tâm reflection CHỈ được sau ≥1 action concrete.
...
S15. TEMPLATE PATTERN CHECK (Phase Q 2026-05-13 — anti "viết lại đoạn cuối"):
- Kết chương có 1 trong các câu sau → moderate per occurrence:
  • "Trò chơi / Ván cờ / Cuộc chiến / Cuộc phiêu lưu / Bước đi mới thực sự / thật sự / bây giờ mới bắt đầu"
  • "Hắn / Y / Cô / Nàng là [Tên MC], và đây là thế giới của hắn/y/cô/nàng"
  • "Đối với [Tên MC], đây chỉ mới là khởi đầu" / "Tương lai còn dài"
- Opening 100 từ đầu match pattern "[ánh sáng / không khí / khung cảnh] + [Tên MC] đứng/ngồi bất động + nhìn/quan sát/lặng lẽ + suy ngẫm/nhớ lại" → moderate.
- 2+ pattern trên xuất hiện cùng chương → critical + REWRITE (vì combo này khiến reader cảm thấy "viết lại đoạn cuối ch.N").
