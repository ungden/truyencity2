...
export const FOCUS_PRESETS: Record<FocusKey, FocusPreset> = {
  'thien-dao-thu-vien': {
    ...
    promptContext: [
      ...
      '- Bàn tay vàng Vạn Văn Ký Ức tái hiện các tác phẩm/ký ức Trái Đất theo kiểu "giữ hồn nguyên tác, đổi vỏ dị giới": ledger/nội tâm PHẢI ghi rõ template gốc Trái Đất là bộ nào (ví dụ Anh Hùng Xạ Điêu/Tiếu Ngạo/Tam Quốc...), nêu rõ nhân vật gốc làm gì/vì sao hay (Quách Tĩnh vụng mà chính, Hoàng Dung thông minh lanh lợi, Hồng Thất Công truyền chưởng...), giữ xương sống cốt truyện, đại cảnh, nhịp cao trào và payoff. Không đổi 100%; chỉ đổi những phần cần hợp luật Thiên Đạo.',
      ...
      '- Có template ledger cho mỗi tác phẩm Trái Đất: tên template gốc rõ ràng, nhân vật gốc/role gốc, họ làm gì trong đại cảnh, xương sống nguyên tác, các đại cảnh phải giữ, yếu tố nào giữ nguyên, yếu tố nào đổi tên, võ học/công pháp dự kiến sinh ra.',
      '',
      ...
      '- Khi viết tác phẩm dựa trên nguyên tác Trái Đất, chương phải bám template ledger và gọi tên template gốc + nhân vật/cảnh gốc trong nội tâm/Vạn Văn Ký Ức để độc giả thật nhận ra hồi ức; không tự bẻ sang truyện mới nếu chưa có lý do trong Vạn Văn Ký Ức.',
      '- Không để tác phẩm tạo skill vô nguồn: phải có tác phẩm -> cảnh đọc/nhập tâm -> lĩnh ngộ -> phản ứng -> phần thưởng/danh vọng.',
      '- Không bê nguyên văn từng đoạn có bản quyền; nhưng tên truyện/nhân vật/cảnh gốc có thể và nên xuất hiện trong nội tâm/Vạn Văn Ký Ức. Bản công bố dị giới có thể giữ một phần tên/role quen thuộc hoặc đổi nhẹ, miễn độc giả ngoài đời nhận ra hồi ức từ tác phẩm nào.',
    ...
    requiredSetupKeywords: [
      ...
      { code: 'earth_template_spine', label: 'xương sống nguyên tác Trái Đất', keywords: ['template ledger', 'template gốc', 'xương sống', 'nguyên tác', 'giữ hồn', 'đại cảnh', 'anh hùng xạ điêu', 'tiếu ngạo', 'tam quốc'] },
    ],
  },
  'sang-the-than-minh': {
