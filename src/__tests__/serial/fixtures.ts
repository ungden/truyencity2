...
export const cycle = (
  ...
  return CyclePlanSchema.parse({
    ...
    customerLoop: {
      ...
      purchaseTerms: { quantity: 1, unit: 'lá', consideration: 'Ba tinh hạch Nhất giai.' },
      ...
      returnUpgradeTerms: { quantity: 1, unit: 'lá', consideration: 'Đặt cọc hai tinh hạch Nhất giai.' },
      returnUpgrade: 'Hắn quay lại đặt pháp khí cho cả đội.',
      schedule: {
        purchaseChapter: startChapter,
        useToEarnChapter: startChapter + 1,
        publicProofChapter: startChapter + 2,
        returnUpgradeChapter: startChapter + 3,
      },
    },
