...
ALTER TABLE public.ai_story_projects DROP CONSTRAINT IF EXISTS chk_setup_stage;
ALTER TABLE public.ai_story_projects ADD CONSTRAINT chk_setup_stage CHECK (setup_stage IN (
...
WHERE world_description IS NULL OR main_character = '';
;
