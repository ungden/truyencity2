-- Promotion now requires blind A/B evidence across the two complete
-- 20-chapter sequential corpora selected by Writer discovery.
...
AS $$
  SELECT EXISTS (
    ...
    WHERE benchmark.id = p_benchmark_id
      ...
      AND competing_validation.benchmark_protocol_version = 'story-factory-sequential-survival-v2-causal-continuity'
