...
ALTER TABLE ai_story_projects ADD COLUMN IF NOT EXISTS martial_arts_system TEXT;
-- kiem-hiep
ALTER TABLE ai_story_projects ADD COLUMN IF NOT EXISTS apocalypse_type TEXT;
-- mat-the
ALTER TABLE ai_story_projects ADD COLUMN IF NOT EXISTS supernatural_system TEXT;
-- linh-di
ALTER TABLE ai_story_projects ADD COLUMN IF NOT EXISTS political_system TEXT;
-- quan-truong
ALTER TABLE ai_story_projects ADD COLUMN IF NOT EXISTS world_system TEXT;
-- di-gioi
ALTER TABLE ai_story_projects ADD COLUMN IF NOT EXISTS romance_type TEXT;
-- ngon-tinh
