-- A ten-chapter review is part of the chapter commit gate and must run before
-- the daily production quota delays the next writing attempt.
...
BEGIN
  ...
  SET current_chapter = p_expected_chapter,
      ...
      next_run_at = CASE
        WHEN p_expected_chapter % 10 = 0 THEN now()
