-- A rolling plan is consumed after at most five chapters. Move the job back to
-- planning as part of the same chapter transaction instead of leaving an empty
-- plan in the write stage.
...
BEGIN
  ...
  SET current_chapter = p_expected_chapter,
      ...
      status = 'ready',
      stage = CASE
        WHEN p_expected_chapter % 10 = 0 THEN 'window_review'
