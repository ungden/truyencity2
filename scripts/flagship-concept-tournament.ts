...
import { runConceptTournament, type ScoredConceptCandidateV2 } from '../src/services/story-engine/flagship/concept-tournament';
...
const candidates = JSON.parse(readFileSync(inputPath, 'utf8')) as ScoredConceptCandidateV2[];
